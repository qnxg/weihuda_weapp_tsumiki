    ...
    <View className="flex flex-col gap">
      <View className="flex flex-col gap-sm">
        ...
        <Table cols={3}>
          ...
          <TableHead>单项得分</TableHead>
          <TableHead>单项成绩</TableHead>

          <TableCell color="green">正常</TableCell>
          <TableCell>100</TableCell>
          <TableCell>17.9-23.9</TableCell>

          <TableCell color="blue">低体重</TableCell>
          <TableCell span={2}>80</TableCell>
          <TableCell>≤ 17.8</TableCell>
          <TableCell color="orange">超重</TableCell>
          <TableCell>24.0-27.9</TableCell>

          <TableCell color="red">肥胖</TableCell>
      ...
      <View className="flex flex-col gap-sm">
        ...
        <Table cols={4}>
          ...
          <TableCell color="red" span={5}>不及格</TableCell>
      ...
      <View className="flex flex-col gap-sm">
        ...
        <Table cols={4}>
          ...
          <TableCell color="orange" span={5}>及格</TableCell>
